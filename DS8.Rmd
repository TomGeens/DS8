...
The results of this and all previous modelling steps are shown in the tables 1 and 2.
...
names(predictions)<-c("problem_id","modTree0","modTree1","modRf0","modRf1","modRf2","modRf3","modRf4")
